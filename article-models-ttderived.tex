...
\jcomp{{A}{P}}{\jvcomp{P}{f}{F}}{\jvcomp{Q}{g}{G}}
& \jdeq
  \unfold{\jcomp{{A}{P}}{\unfold{\jvcomp{P}{f}{F}}}{\unfold{\jvcomp{Q}{g}{G}}}}
  \tag{by definition}
  \\
& \jdeq
  \subst
    {F}
    { {\ctxwk{P}{f}}
      {\ctxwk{\ctxext{A}{P}}{\tmext{\ctxwk{Q}{g}}{G}}}
      }
  \tag{by \autoref{comp-es}}
  \\
& \jdeq
...
& \jdeq
  \subst
    {F}
    { \ctxwk{P}{\subst{f}{\ctxwk{A}{\tmext{\ctxwk{Q}{g}}{G}}}}
      }
  \tag{by \autoref{comp-ws-t}}
  \\
& \jdeq
...
& \jdeq
  \subst
    {F}
    {\ctxwk{P}{\tmext{}{}{\jcomp{A}{f}{\ctxwk{Q}{g}}}{\jcomp{A}{f}{G}}}}
\end{align*}
\end{proof}
...
\jfcomp{A}{f}{P}{F}{\jfcomp{B}{g}{Q}{G}{S}}
& \jdeq
  \jcomp{P}{F}{\jcomp{A}{f}{\jcomp{Q}{G}{\jcomp{B}{g}{S}}}}
  \tag{by definition}
  \\
& \jdeq 
  \unfoldall{\jcomp{P}{F}{\jcomp{A}{f}{\jcomp{Q}{G}{\jcomp{B}{g}{S}}}}}
  \tag{by definition}
  \\
& \jdeq 
\end{align*}
...
\begin{rmk}
Instead of looking at $f$ as a context morphism from $\ctxext{P}{\jcomp{}{e}{P}}$
to $P$, one could also look at $f$ as a morphism \emph{over $\cprojfstf{A}{P}$},
...
\end{tikzcd}
\end{equation*}
This makes it clear that $f$ takes a family over an extended context as an
argument. The extended context consists of a `base part' and a `family part'. 
The output of $f$ is a new (extended) family over that base part. Forgetting 
...
\begin{align*}
\jhom*{{{\Gamma}{A}}{P}}{\ctxext{\ctxwk{P}{B}}{Q}}{\jcomp{}{e}{B}}{g}\\
...
\ctxext{P}{\jcomp{}{e}{P}}
  \ar{r}[swap]{f}
  \ar[shift right=.7ex,dotted]{u}[swap]{\jcomp{}{f}{\jcomp{}{e}{x}}}
& P
  \ar[shift right=.7ex,dotted]{u}[swap]{\jcomp{}{e}{x}}
\end{tikzcd}
\end{equation*}
commute.
\end{defn}
...
\jterm*{{{\Gamma}{A}}{P}}{\subst{\jcomp{}{e}{x}}{\ctxwk{\ctxext{A}{P}}{Q}}}{y}.
\end{align*}
Thus, $x$ is a context morphism from $A$ to $B$ and $y$ is nothing but a term
of $\jcomp{}{\jcomp{}{e}{x}}{Q}$. For $x$, we see that the diagram
\begin{equation*}
\begin{tikzcd}
\ctxext{B}{Q} 
  \ar{r}{g} 
