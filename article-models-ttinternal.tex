...
\jhom
  ...
  {\cftwk{\cftalg{A}}}
\end{equation*}
be a homomorphism of term-algebras for which the diagram in
\autoref{diag:cftwk-cftwk} commutes judgmentally. Then
we have the judgmental equality
\begin{align*}
& \jcomp{}
  { \subst{q}{{{b}{{\gamma}{\cftctxext}}}{\cftwk{\cftalg{A}}}}
    }
  { \subst
      {{q}{{b}{\cftfamext}}}
...
& \jdeq
  \jcomp{}
    ...
    { \subst
        ...
        { {{{b}{{a}{{\gamma}{\cftwkc{\cftalg{A}}}}}}{{{a}{{\gamma}{\cftctxext}}}{\cftctxext}}}
          {\cftwk{\cftalg{A}}}
          }
      }
\end{align*}
...
\begin{equation}\label{eq:cftwk-currying}
\jhomeq
  { {{{\Gamma}{\cftalgc{\cftalg{A}}}}{\cftalgf{\cftalg{A}}}}
    {\cftalgf{\cftalg{F_A}}}
    }
  ...
  { \jcomp{}{\ctxwk{\cftalgf{\cftalg{F_A}}}{\cftwk{\cftalg{A}}}}{\jcomp{}{\cftctxext}{\cftwk{\cftalg{A}}}}
    }
\end{equation}
...
$ \jhom
  ...
  {\cftwk{\cftalg{A}}}
$
satisfying the judgmental equality of \autoref{eq:cftwk-currying}. Then we
have the judgmental equality
\begin{equation*}
\subst{{p}{{a}{\cftfamext}}}{{\gamma}{\cftwk{\cftalg{A}}}}
\jdeq
\jcomp{}
    {\subst{a}{{\gamma}{\cftwk{\cftalg{A}}}}}
    {\subst{p}{{{a}{{\gamma}{\cftctxext}}}{\cftwk{\cftalg{A}}}}}
\end{equation*}
