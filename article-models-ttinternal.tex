...
( \ctxwk{P}{P},
  \ctxwk{P}{\jcomp{}{\epsilon_0}{P}},
  \ctxwk{P}{\epsilon_1},
  \ctxwk{P}{\jcomp{}{\epsilon_0}{\epsilon_1}})
...
letting contexts and families interact, the empty object is a term which
requires that contexts and families are compatible and weakening is an operation
which takes families to extended families. However, we need to consider
the notion of term-algebras before we can go into the internalization of
substitution. In this subsection we will define the notion of term-algebras
with extension and an empty object (which are simply called term-algebras),
term-homomorphisms between them and weakening term-algebras with their
homomorphisms.
