...
consisting of 
\begin{enumerate}
\item a family $\cftalgc{\cftalg{A}}$ over context $\Gamma$, 
\item a family $\cftalgf{\cftalg{A}}$ over the context
$\ctxext{\Gamma}{\cftalgc{\cftalg{A}}}$,
\item a morphism $\cftctxext[\cftalg{A}]$ from $\ctxext{\cftalgc{\cftalg{A}}}{
\cftalgf{\cftalg{A}}}$ to $\cftalgc{\cftalg{A}}$ in context
$\Gamma$
\item a morphism $\cftfamext[\cftalg{A}]$ from 
...
for $\cfthom{F_f}$ gives us quite directly \autoref{eq:extalg-hom2}. The
diagram in \autoref{eq:extalg-hom2} for $\cfthom{F_f}$ is judgmentally equal
to the pullback of everything in the diagram in \autoref{eq:extalg-hom2} for
