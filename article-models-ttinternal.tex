...
\begin{equation}\label{diag:cftwk-curry}
...
$ \jhom
  ...
  {\cftwk{\cftalg{A}}}
$
satisfying the judgmental equality of \autoref{diag:cftwk-curry}. Then we
...
\autoref{diag:cftwk-curry} pulled back along $\cftctxext$. Thus, we are going
to show that
\begin{align*}
...
\end{align*}
For the forth, note that we have the judgmental equalities
\begin{align*}
\jcomp{}
      { \cftwkf{\cftfamalg{\cftalg{A}}}}
      { \jcomp{}
...
\end{align*}
Thus we may conclude that the diagram above of which we had the aim to show that
it commutes judgmentally is a pullback of the diagram in \autoref{diag:cftwk-cftwk}
