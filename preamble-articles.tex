...
%%%% IDENTITY FUNCTIONS
%%%%
%%%% We currently just use \idfunc but this should probably change because that
%%%% is the lambda-abstracted version of our identity morphisms
%%%%
%%%% -- TO CONSTRUCT
