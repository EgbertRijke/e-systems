...
\newcommand{\jextalgtm}{%
  \@ifnextchar*{\@jextalgtmAlignTrue}{\@jextalgtmAlignFalse}}
\newcommand{\@jextalgtmAlignTrue}[3]{%
  \jfam*{{#2}{\cftalgf{\cftalg{#3}}}}{\cftalgt{\cftalg{#3}}}}
\newcommand{\@jextalgtmAlignFalse}[2]{%
  \jfam{{#1}{\cftalgf{\cftalg{#2}}}}{\cftalgt{\cftalg{#2}}}}
