...
\newcommand{\@judgmentAF}[7]{\@judgment@ctx{#1} \vdash \@judgment@rel{#2}{#3}{#4}{#5}{#6} #7}
...
\newcommand{\@judgment@ext}[1]{\@ifnextchar\bgroup{\ctxext}{}#1}

%%%% Judgments about contexts
\newcommand{\jctx@sym}{\@judgment@kind{ctx}}

\newcommand{\jctx}{\@ifnextchar*{\@jctxAlignTrue}{\@jctxAlignFalse}}
\newcommand{\@jctxAlignTrue}[2] %{& \vdash #2~~\textit{ctx}}
  {\judgment*{}{}{}{}{}{#2}{\jctx@sym}}
\newcommand{\@jctxAlignFalse}[1] %{\vdash #1~~\textit{ctx}}
  {\judgment{}{}{}{}{}{#1}{\jctx@sym}}

\newcommand{\jctxeq}{\@ifnextchar*{\@jctxeqAlignTrue}{\@jctxeqAlignFalse}}
\newcommand{\@jctxeqAlignTrue}[3] %{& \vdash #2\jdeq #3~~\textit{ctx}}
  {\judgment*{}{#2}{\jdeq}{#3}{}{}{\jctx@sym}}
\newcommand{\@jctxeqAlignFalse}[2] %{\vdash #1\jdeq #2~~\textit{ctx}}
  {\judgment{}{#1}{\jdeq}{#2}{}{}{\jctx@sym}}

\newcommand{\jctxdefn}{\@ifnextchar*{\@jctxdefnAlignTrue}{\@jctxdefnAlignFalse}}
\newcommand{\@jctxdefnAlignTrue}[3] %{& \vdash #2\defeq #3~~\textit{ctx}}
    {\judgment*{}{#2}{\defeq}{#3}{}{}{\jctx@sym}}
\newcommand{\@jctxdefnAlignFalse}[2] %{\vdash #1\defeq #2~~\textit{ctx}}
...
\newcommand{\@jfamAlignTrue}[3] %{#2 & \vdash #3~~\textit{fam}}
  {\judgment*{#2}{}{}{}{}{#3}{\jfam@sym}}
\newcommand{\@jfamAlignFalse}[2] %{#1 \vdash #2~~\textit{fam}}
  {\judgment{#1}{}{}{}{}{#2}{\jfam@sym}}

\newcommand{\jfameq}{\@ifnextchar*{\@jfameqAlignTrue}{\@jfameqAlignFalse}}
\newcommand{\@jfameqAlignTrue}[4] %{#2 & \vdash #3\jdeq #4~~\textit{fam}}
  {\judgment*{#2}{#3}{\jdeq}{#4}{}{}{\jfam@sym}}
\newcommand{\@jfameqAlignFalse}[3] %{#1 \vdash #2\jdeq #3~~\textit{fam}}
  {\judgment{#1}{#2}{\jdeq}{#3}{}{}{\jfam@sym}}

\newcommand{\jfamdefn}{\@ifnextchar*{\@jfamdefnAlignTrue}{\@jfamdefnAlignFalse}}
\newcommand{\@jfamdefnAlignTrue}[4] %{#2 & \vdash #3\defeq #4~~\textit{fam}}
  {\judgment*{#2}{#3}{\defeq}{#4}{}{}{\jfam@sym}}
\newcommand{\@jfamdefnAlignFalse}[3] %{#1 \vdash #2\defeq #3~~\textit{fam}}
...
\newcommand{\@jtypeAlignTrue}[3] %{#2 & \vdash #3~~\textit{type}}
  {\judgment*{#2}{}{}{}{}{#3}{\jtype@sym}}
\newcommand{\@jtypeAlignFalse}[2] %{#1\vdash #2~~\textit{type}}
  {\judgment{#1}{}{}{}{}{#2}{\jtype@sym}}
  
\newcommand{\jtypeeq}{\@ifnextchar*{\@jtypeeqAlignTrue}{\@jtypeeqAlignFalse}}
\newcommand{\@jtypeeqAlignTrue}[4] %{#2 & \vdash #3\jdeq #4~~\textit{type}}
  {\judgment*{#2}{#3}{\jdeq}{#4}{}{}{\jtype@sym}}
\newcommand{\@jtypeeqAlignFalse}[3] %{#1\vdash #2\jdeq #3~~\textit{type}}
  {\judgment{#1}{#2}{\jdeq}{#3}{}{}{\jtype@sym}}

\newcommand{\jtypedefn}{\@ifnextchar*{\@jtypedefnAlignTrue}{\@jtypedefnAlignFalse}}
\newcommand{\@jtypedefnAlignTrue}[4] %{#2 & \vdash #3\defeq #4~~\textit{type}}
  {\judgment*{#2}{#3}{\defeq}{#4}{}{}{\jtype@sym}}
\newcommand{\@jtypedefnAlignFalse}[3] %{#1\vdash #2\defeq #3~~\textit{type}}
...
\newcommand{\@jtermdefnAlignTrue}[5] %{#2 & \vdash #4\defeq #5:#3}
  {\judgment*{#2}{#4}{\defeq}{#5}{:}{#3}{}}
\newcommand{\@jtermdefnAlignFalse}[4] %{#1\vdash #3\defeq #4:#2}
...
\newcommand{\@jvfamAlignFalse}[3]{\jfam{#1:#2}{\vardis{#1}{#3}}}
...
\newcommand{\@jvfameqAlignFalse}[4]{\jfameq{#1:#2}{\vardis{#1}{#3}}{\vardis{#1}{#4}}}

\newcommand{\jvtype}{\@ifnextchar*{\@jvtypeAlignTrue}{\@jvtypeAlignFalse}}
\newcommand{\@jvtypeAlignTrue}[4]{\jtype*{#2:#3}{\vardis{#2}{#4}}}
\newcommand{\@jvtypeAlignFalse}[3]{\jtype{#1:#2}{\vardis{#1}{#3}}}
...
\newcommand{\@jvtypeeqAlignFalse}[4]{\jtypeeq{#1:#2}{\vardis{#1}{#3}}{\vardis{#1}{#4}}}

\newcommand{\jvterm}{\@ifnextchar*{\@jvtermAlignTrue}{\@jvtermAlignFalse}}
\newcommand{\@jvtermAlignTrue}[5]{\jterm*{#2:#3}{\vardis{#2}{#4}}{\vardis{#2}{#5}}}
\newcommand{\@jvtermAlignFalse}[4]{\jterm{#1:#2}{\vardis{#1}{#3}}{\vardis{#1}{#4}}}
...
\newcommand{\@jvtermeqAlignFalse}[5]{\jtermeq{#1:#2}{\vardis{#1}{#3}}{\vardis{#1}{#4}}{\vardis{#1}{#5}}}
\makeatother
...
\makeatletter
\newcommand{\cprojgenf}[3]{\typefont{pr}^{
  \@ifnextchar\ctxext{\@ctxext@nested}{}#2,
  \@ifnextchar\ctxext{\@ctxext@nested}{}#3}_{#1}}
\newcommand{\cprojgen}[4]{\subst{#4}{\cprojgenf{#1}{#2}{#3}}}
\makeatother

\newcommand{\cprojfstf}[2]{\cprojgenf{0}{#1}{#2}}
\newcommand{\cprojfst}[3]{\cprojgen{0}{#1}{#2}{#3}}
\newcommand{\cprojsndf}[2]{\cprojgenf{1}{#1}{#2}}
\newcommand{\cprojsnd}[3]{\cprojgen{1}{#1}{#2}{#3}}
...
\newcommand{\jhom@dom@wk}[2]{
  \jhom@dom@choice{\jhom@dom@wk@root #1\protect\null}
                  {\jhom@dom@wk@branchone #1\protect\null}
                  {\jhom@dom@wk@branchtwo #1\protect\null}
                  {#2}}
\newcommand{\jhom@dom@choice}[4]{
  \ifx {#1\protect\null}{\protect\null}
  \@jhom@dom@wk@branches{#2}{#3}{#4}
  \else
  \@jhom@dom@wk@root{#1}{#4}
  \fi
}
\newcommand{\@jhom@dom@wk@branches}[3]{\expandafter{\expandafter{\jhom@dom@wk}{#1}}{\jhom@dom@wk{#2}{#3}}}
\newcommand{\@jhom@dom@wk@root}[2]{\ctxwk{#1}{#2}}

\newcommand{\jhom@dom@wk@root}{\@ifnextchar\bgroup{\jhom@dom@wk@eat}{}}

\newcommand{\jhom@dom@wk@branchone}{\@ifnextchar\bgroup{\@jhom@dom@wk@branchone}{\jhom@dom@wk@eat}}
\newcommand{\@jhom@dom@wk@branchone}[1]{#1\jhom@dom@wk@eat}

\newcommand{\jhom@dom@wk@branchtwo}{\@ifnextchar\bgroup{\@jhom@dom@wk@branchtwo}{\jhom@dom@wk@eat}}
\newcommand{\@jhom@dom@wk@branchtwo}[1]{\@ifnextchar\bgroup{\@@jhom@dom@wk@branchtwo}{\jhom@dom@wk@eat}}
\newcommand{\@@jhom@dom@wk@branchtwo}[1]{#1\jhom@dom@wk@eat}

\newcommand{\jhom@dom@wk@eat}[1]{\@ifnextchar{\@let@token\null}{}{\jhom@dom@wk@eat}}
\makeatother
