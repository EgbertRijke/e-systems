...
\makeatletter
\newcommand{\ctxext}[2]{\@ctxext #1.\@ctxext #2}
\newcommand{\@ctxext}{\@ifnextchar\bgroup{\@@ctxext}{}}
\newcommand{\@@ctxext}[1]{\@ifnextchar\bgroup{(\@ctxext@paren{#1}}{#1}}
\newcommand{\@ctxext@paren}[2]{\ctxext{#1}{#2})}
\makeatother
...
\makeatletter
\newcommand{\subst}[2]{\@subst #2[\@subst #1]}
...
\makeatletter
\newcommand{\ctxwk}[2]{\langle\@ctxwk #1\rangle\@ctxwk #2}
