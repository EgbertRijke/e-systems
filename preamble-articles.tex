...
\newcommand{\tmext}[4]{%
  \ctxext{\default@tmext #3}{\default@tmext #4}}
...
\newcommand{\jcomp@unfold}[3]{%
  \subst{#2}{\ctxwk{\default@ctxext #1}{#3}}}
...
\newcommand{\mfam}[1]{%
  \mathcal{F}_{\default@ctxext #1}}

%%%% The terms constructor
\newcommand{\mtm}[1]{%
  \mathcal{T}_{\default@ctxext #1}}
...
\newcommand{\tfid}[1]{%
  \typefont{idfun}_{\default@ctxext #1}}
\makeatother
