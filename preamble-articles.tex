...
\newcommand{\@judgment@ext}[1]{\@ctxext@default#1}
...
\makeatletter
\newcommand{\tfemp}[1]{\typefont{emp}_{\@ctxext@default #1}}
\makeatother
...
\makeatletter
\newcommand{\tfext}[1]{\typefont{ext}_{\@ctxext@default #1}}
\makeatother
...
\newcommand{\@ctxext@ctx}{\@ifnextchar\ctxext{\@ctxext@nested}{\@ifnextchar\ctxwk{\@ctxwk@nested}{\@ifnextchar\jcomp{\@jcomp@nested}{\@ctxext}}}}
\newcommand{\@ctxext@type}{\@ifnextchar\ctxext{\@ctxext@nested}{\@ifnextchar\subst{\@subst@nested}{\@ifnextchar\jcomp{\@jcomp@nested}{\@ctxext}}}}
...
\newcommand{\@ctxext@default}{\@ifnextchar\bgroup{\ctxext}{}}
\newcommand{\@ctxext@default@parens}{\@ifnextchar\bgroup{\@ctxext@parens}{}}
\makeatother
...
\makeatletter
\newcommand{\tfsubst}[1]{\typefont{subst}_{\@ctxext@default #1}}
\makeatother
...
\newcommand{\@subst@type}{\@ifnextchar\ctxext{\@ctxext@nested}{\@ifnextchar\ctxwk{\@ctxwk@nested}{\@ifnextchar\jcomp{\@jcomp@nested}{\@subst}}}}
...
\makeatletter
\newcommand{\tfwk}[1]{\typefont{wk}_{\@ctxext@default #1}}
\makeatother
...
\newcommand{\@ctxwk@pass}{\@ifnextchar\ctxext{\@ctxext@nested}{\@ifnextchar\subst{\@subst@nested}{\@ifnextchar\jcomp{\@jcomp@nested}{\@ctxwk}}}}
...
\makeatletter
\newcommand{\tfid}[1]{\typefont{idfun}_{\@ctxext@default #1}}
\newcommand{\jhom}[4]{\jterm{{#1}{#2}}{\ctxwk{\@ctxext@default #2}{\@ctxext@default@parens #3}}{#4}}
\newcommand{\jhomeq}[5]{\jtermeq{{#1}{#2}}
  {\ctxwk{\@ctxext@default #2}{\@ctxext@default@parens #3}}{#4}{#5}}
\newcommand{\jhomdefn}[5]{\jtermdefn{{#1}{#2}}{\ctxwk{#2}{#3}}{#4}{#5}}
\newcommand{\jcomp}[2]{\jcomp@testleft #2 \circ \jcomp@testright #1}
...
\newcommand{\@jcomp@nested}[3]{\@jcomp@parens{#2}{#3}}
\newcommand{\@jcomp@parens}[2]{(\jcomp{#1}{#2})}

\newcommand{\jfhom}[7]{\jterm
  {{{#1}{#2}}{#5}}
  {\ctxwk{\@ctxext@default #5}{\jcomp{#4}{#6}}}
  {#7}}
\makeatother

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%% The compatible unit type

\makeatletter
\newcommand{\unitc}[1]{\unit^0_{\@ctxext@default #1}}
\newcommand{\unitct}[1]{\ttt^0_{\@ctxext@default #1}}
\newcommand{\unitf}[2]{\unit^1_{\@ctxext@default #1,\@ctxext@default #2}}
\newcommand{\unitft}[2]{\ttt^1_{\@ctxext@default #1,\@ctxext@default #2}}
\makeatother
...
\newcommand{\mfam}[1]{\mathcal{F}_{\@ctxext@default #1}}
\newcommand{\mtm}[1]{\mathcal{T}_{\@ctxext@default #1}}
\makeatother
