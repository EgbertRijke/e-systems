...
\newcommand{\@ctxext@ctx}{\@ifnextchar\ctxext{\@ctxext@nested}{\@ifnextchar\ctxwk{\@ctxwk@nested}{\@ifnextchar\jhomcomp{\@jhomcomp@nested}{\@ctxext}}}}
\newcommand{\@ctxext@type}{\@ifnextchar\ctxext{\@ctxext@nested}{\@ifnextchar\subst{\@subst@nested}{\@ifnextchar\jhomcomp{\@jhomcomp@nested}{\@ctxext}}}}
...
\newcommand{\@subst@type}{\@ifnextchar\ctxext{\@ctxext@nested}{\@ifnextchar\ctxwk{\@ctxwk@nested}{\@ifnextchar\jhomcomp{\@jhomcomp@nested}{\@subst}}}}
...
\newcommand{\@ctxwk@pass}{\@ifnextchar\ctxext{\@ctxext@nested}{\@ifnextchar\subst{\@subst@nested}{\@ifnextchar\jhomcomp{\@jhomcomp@nested}{\@ctxwk}}}}
...
\makeatletter
\newcommand{\jhom}[4]{\jterm{{#1}{#2}}{\ctxwk{#2}{#3}}{#4}}
\newcommand{\jhomeq}[5]{\jtermeq{{#1}{#2}}{\ctxwk{\@ifnextchar\bgroup{\ctxext}{}#2}{#3}}{#4}{#5}}
\newcommand{\jhomdefn}[5]{\jtermdefn{{#1}{#2}}{\ctxwk{#2}{#3}}{#4}{#5}}
\newcommand{\jhomcomp}[2]{\jhomcomp@testleft #2 \circ \jhomcomp@testright #1}
\newcommand{\jhomcomp@testleft}{\@ifnextchar\jhomcomp{\@jhomcomp@nested}{\@ifnextchar\ctxwk{\@ctxwk@nested}{}}}
\newcommand{\jhomcomp@testright}{\@ifnextchar\jhomcomp{\@jhomcomp@nested}{\@ifnextchar\subst{\@subst@nested}{}}}
\newcommand{\@jhomcomp@nested}[3]{\@jhomcomp@parens{#2}{#3}}
\newcommand{\@jhomcomp@parens}[2]{(\jhomcomp{#1}{#2})}
