...
\makeatletter
\newcommand{\tfemp}[1]{\typefont{emp}_{\default@ctxext #1}}
\makeatother
...
\makeatletter
\newcommand{\tfext}[1]{\typefont{ext}_{\default@ctxext #1}}
\makeatother
...
\makeatletter
\newcommand{\tfsubst}[1]{\typefont{subst}_{\default@ctxext #1}}
\makeatother
...
\makeatletter
\newcommand{\tfwk}[1]{\typefont{wk}_{\default@ctxext #1}}
\makeatother
...
\newcommand{\tfid}[1]{\typefont{idfun}_{\default@ctxext #1}}
...
\newcommand{\jcomp}[2]{%
  \jcomp@testleft #2 \circ \jcomp@testright #1}
...
\newcommand{\@jcomp@nested}[3]{%
  \@jcomp@parens{#2}{#3}}
\newcommand{\@jcomp@parens}[2]{%
  (\jcomp{#1}{#2})}

\newcommand{\jcomp@unfold}[2]{%
  \subst{f}{\ctxwk{\blank}{#2}}}
\newcommand{\@jcomp@unfold@nested}[3]{%
  \@jcomp@unfold@parens{#2}{#3}}
\newcommand{\@jcomp@unfold@parens}[2]{%
  (\jcomp@unfold{#1}{#2})}

%%%% The judgment that F is a morphism from P to Q over f in context \Gamma.
\newcommand{\jfhom}[7]{\judgment{#1}{}{}{#7}{}{}{\jhomsym[#4]{#5}{#6}}}
\newcommand{\jfhom@unfold}[7]{\jterm
  {{{#1}{#2}}{#5}}
  {\ctxwk{\default@ctxext #5}{\jcomp{#4}{#6}}}
  {#7}}
\makeatother
...
\makeatletter
\newcommand{\unitc}[1]{\unit^0_{\default@ctxext #1}}
\newcommand{\unitct}[1]{\ttt^0_{\default@ctxext #1}}
\newcommand{\unitf}[2]{\unit^1_{\default@ctxext #1,\default@ctxext #2}}
\newcommand{\unitft}[2]{\ttt^1_{\default@ctxext #1,\default@ctxext #2}}
\makeatother
...
\newcommand{\mfam}[1]{\mathcal{F}_{\default@ctxext #1}}
\newcommand{\mtm}[1]{\mathcal{T}_{\default@ctxext #1}}
\makeatother
