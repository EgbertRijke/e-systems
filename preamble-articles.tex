...
%  \@ifnextchar\@jfcomp@parens{\@eatdo{\@jfcomp@unfold@parens}}{%
  ...
  \@ifnextchar\jfvcomp{\@eatdo{\jfvcomp@unfold}}{%
  \@ifnextchar\cftalg{\@eatdo{\cftalg@unfold}}{%
  \@ifnextchar\cfthom{\@eatdo{\cfthom@unfold}}{%
  \@ifnextchar\empalg{\@eatdo{\empalg@unfold}}{%
  \@ifnextchar\extalg{\@eatdo{\extalg@unfold}}{%
  }}}}}}}}}}}}}}}}}}}}}}}%}}
  #1}
\end{comment}
\makeatother
...
\newcommand{\finc@unfold}[3][]{%
  \tmext{\ctxwk{\subst{#2}{#3}}{#1}}{\ctxwk{\subst{#2}{#3}}{#3}}{\ctxwk{\subst{#2}{#3}}{#2}}{\idtm{\subst{#2}{#3}}}}
\makeatother
...
\newcommand{\jextalg}{\@ifnextchar*{\@jextalgAlignTrue}{\@jextalgAlignFalse}}
\newcommand{\@jextalgAlignTrue}[3]{\judgment*{#2}{}{}{}{}{\extalg{#3}}{\extalg@sym}}
\newcommand{\@jextalgAlignFalse}[2]{\judgment{#1}{}{}{}{}{\extalg{#2}}{\extalg@sym}}
...
\newcommand{\jextalgctx}{%
  \@ifnextchar*{\@jextalgctxAlignTrue}{\@jextalgctxAlignFalse}}
\newcommand{\@jextalgctxAlignTrue}[3]{%
  \jfam*{#2}{\cftalgc{\cftalg{#3}}}}
\newcommand{\@jextalgctxAlignFalse}[2]{%
  \jfam{#1}{\cftalgc{\cftalg{#2}}}}

\newcommand{\jextalgfam}{%
  \@ifnextchar*{\@jextalgfamAlignTrue}{\@jextalgfamAlignFalse}}
\newcommand{\@jextalgfamAlignTrue}[3]{%
  \jfam*{#2}{\cftalgf{\cftalg{#3}}}}
\newcommand{\@jextalgfamAlignFalse}[2]{%
  \jfam{#1}{\cftalgf{\cftalg{#2}}}}

\newcommand{\jextalgctxext}{%
  \@ifnextchar*{\@jextalgctxextAlignTrue}{\@jextalgctxextAlignFalse}}
\newcommand{\@jextalgctxextAlignTrue}[3]{%
  \jhom*{#2}{{\cftalgc{\cftalg{#3}}}{\cftalgf{\cftalg{#3}}}}{\cftalgc{\cftalg{#3}}}{\cftctxext[\cftalg{#3}]}}
\newcommand{\@jextalgctxextAlignFalse}[2]{%
  \jhom{#1}{{\cftalgc{\cftalg{#2}}}{\cftalgf{\cftalg{#2}}}}{\cftalgc{\cftalg{#2}}}{\cftctxext[\cftalg{#2}]}}

\newcommand{\jextalgfamext}{%
  \@ifnextchar*{\@jextalgfamextAlignTrue}{\@jextalgfamextAlignFalse}}
\newcommand{\@jextalgfamextAlignTrue}[3]{%
  \jhom*{{#2}{\cftalgc{\cftalg{#3}}}}{{\cftalgf{\cftalg{#3}}}{\jcomp{}{\cftctxext[\cftalg{#3}]}{\cftalgf{\cftalg{#3}}}}}{\cftalgf{\cftalg{#3}}}{\cftfamext[\cftalg{#3}]}}
\newcommand{\@jextalgfamextAlignFalse}[2]{%
  \jhom{{#1}{\cftalgc{\cftalg{#2}}}}{{\cftalgf{\cftalg{#2}}}{\jcomp{}{\cftctxext{\cftalg{#2}}}{\cftalgf{\cftalg{#2}}}}}{\cftalgf{\cftalg{#2}}}{\cftfamext[\cftalg{#2}]}}
  
\newcommand{\exthomcomp}[2]{#2\circ #1}
\newcommand{\exthomcomp@unfold}[2]{%
  ( \jcomp{}{\exthomc{#1}}{\exthomc{#2}},
    \jfcomp{}{}{}{\exthomf{#1}}{\exthomf{#2}})
  }

\newcommand{\extalgc}[1]{\@gobble #1}
\newcommand{\extalgf}[1]{\mathcal{F}_{#1}}
\newcommand{\exthomc}[1]{\@gobble #1}
\newcommand{\exthomf}[1]{\mathcal{F}_{#1}}

\newcommand{\empalg}{\algfont}

\newcommand{\empalg@unfold}[1]{%
  ( \cftalgc{\cftalg{#1}},
    \cftalgf{\cftalg{#1}},
    \cftalgt{\cftalg{#1}},
    \cftempc{\cftalg{#1}},
...
\newcommand{\exthom}{\algfont}
\newcommand{\exthom@unfold}[1]{%
  ( \cfthomc{\cfthom{#1}},
    \cfthomf{\cfthom{#1}})
  }
...
\newcommand{\cftempc}{\cftemp[\mathsf{c}]}
\newcommand{\cftempf}{\cftemp[\mathsf{f}]}

\newcommand{\cftwk}[1]{\boldsymbol\omega^{#1}}
\newcommand{\cftwkc}[1]{\omega^{#1}}
\newcommand{\cftwkf}[1]{\mathcal{F}_{\omega^{#1}}}
\newcommand{\cftwkt}[1]{\mathcal{T}_{\omega^{#1}}}

\newcommand{\cftsubst}[2][]{\boldsymbol\sigma_{#1}^{#2}}
\newcommand{\cftsubstc}[1]{\cftsubst[\mathsf{c}]{#1}}
\newcommand{\cftsubstf}[1]{\cftsubst[\mathsf{f}]{#1}}
\newcommand{\cftsubstt}[1]{\cftsubst[\mathsf{t}]{#1}}

\newcommand{\cftidtm}[1]{\boldsymbol\iota^{#1}}

%%%% The family algebra
\newcommand{\cftfamalg}[1]{\mathcal{F}_{#1}}
\makeatother
