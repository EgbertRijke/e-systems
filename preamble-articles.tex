...
\newcommand{\cftempc}[1]{\cftemp[\mathsf{c}]{#1}}
\newcommand{\cftempf}[1]{\cftemp[\mathsf{f}]{#1}}

\newcommand{\cftwk}[2][]{\omega_{#1}^{#2}}
\newcommand{\cftwkc}[1]{\cftwk[\mathsf{c}]{#1}}
\newcommand{\cftwkf}[1]{\cftwk[\mathsf{f}]{#1}}
\newcommand{\cftwkt}[1]{\cftwk[\mathsf{t}]{#1}}

\newcommand{\cftsubst}[2][]{\sigma_{#1}^{#2}}
