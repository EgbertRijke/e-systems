...
\DeclareCaptionFormat{myformat}{#1#2#3{\color{black!20}\hrulefill}}
...
%%%% For some mysterious reason LaTeX confuses extalg and empalg when
%%%% `\newcommand` is used rather than `\def`. I'm completely clueless about
%%%% why this happens.
