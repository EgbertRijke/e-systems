...
\newcommand{\graphcharmapfunc}[1]{\chi_{#1}}
...
%%%% \ctxext{A}{B}{C}D will print A.B.C.D
%%%% \ctxext({A}{B})C will print (A.B).C
%%%% \ctxext{A}({B}C) wil print A.(B.C)
%%%% \ctxext({A}({B}{C}))D will print (A.(B.C)).D

\makeatletter
\newcommand{\ctxext}{
  \@ifnextchar\bgroup
  % then perform the context extension operation
  { \@ctxext}
  % else test whether the next token is an opening parenthesis
  { \@ifnextchar{(}
    % then place an opening parenthesis and return to \ctxext
    { (\@ctxextskipnextchar}
    % else test whether the next token is a closing parenthesis
    { \@ifnextchar{)}
      % then ignore rhe closing parenthesis and return to \ctxext
      { \@ctxextskipnextchar}
      % else do nothing
      {}
    }
...
\newcommand{\@ctxext}[1]{#1\@ctxextgatherparensthendot}
\newcommand{\@ctxextskipnextchar}[1]{\ctxext}
\newcommand{\@ctxextgatherparensthendot}{\@ifnextchar{)}{)\@@ctxextgatherparensthendot}{.\ctxext}}
\newcommand{\@@ctxextgatherparensthendot}[1]{\@ctxextgatherparensthendot}
\makeatother

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

\newcommand{\tfext}{\typefont{ext}}
\newcommand{\ctxwk}[2]{{\langle #1\rangle#2}}
...
%\makeatletter
%\@addtoreset{modelenumi}{enumi}
%\makeatother
%\newenvironment{modelenumerate}
%{ \begingroup
%  \renewcommand{\theenumi}{(M.\arabic{enumi})}
%  \renewcommand{\labelenumi}{\theenumi}
%  \begin{enumerate}
%  \setcounter{enumi}{modelenumi}
%}
%{ %\setcounter{modelenumi}{enumi}
%  \end{enumerate}\endgroup
%}

%% New theorem environment. This should ultimately be removed.
