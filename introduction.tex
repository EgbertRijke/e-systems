...
a E-system is therefore an algebra consisting of three sorts: $C$ for contexts,
...
which family it is a term. Thus, the backbones of a E-system can be represented
as
\begin{equation*}
\begin{tikzcd}
