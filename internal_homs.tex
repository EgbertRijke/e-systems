\section{Elementary properties of context algebras}\label{sec:esys_props}

The theory of context algebras could be seen as a sort of category theory with only
...
that the notions of context algebra and E'-system are the same. In \autoref{sec:E'}
we show directly that any E'-system is a context algebra. We end this section by
...
directly to anything in a context algebra.
\end{rmk}
...
\begin{thm}
A context algebra is the same thing as an E'-system.
\end{thm}
...
It remains to verify the rest of the conditions of context algebras.
\begin{itemize}
...
\begin{comment}
We then demonstrate how to define a category internal to a context algebra. The main
point of this lies mainly in demonstrating how the operations of context algebras can
...
conditions on context algebras.
...
internal category is. In fact, it is possible to define a context algebra internal
to a context algebra, just using the algebraic structure of a context algebra, and actually
...
\begin{thm}
For each object $\Gamma$ of a context algebra $\mathbb{E}$, we have a pre-category
...
\subsection{Context algebras are E'-systems}
...
\begin{thm}
Context algebras are the same things as E'-systems.
\end{thm}
...
We have described functors from E'-systems to context algebras and vice versa. It is
...
\begin{rmk}
When $\mathcal{E}$ is a context algebra with empty context, then we have the category
...
\section{Indexed context algebras}
\begin{defn}
...
\item Can they all be strictified? Are there more examples of weak context algebras?
\end{itemize}
\end{rmk}
\end{comment}
