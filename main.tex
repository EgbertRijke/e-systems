...
expressions for judgments and for inference rules. One reason is that it has been
proven to be hard for the uninitiated to read and comprehend such expressions.
Another is that set theoretic
notation serves very well for getting the algebraic structure accross, which
