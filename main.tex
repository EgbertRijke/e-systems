...
\subsection*{Principles of mathematical fuseki}
Mathematics is the study of abstract concepts such as space or quantity, and
when we design a language for such a study, we want to be able to efficiently
express things about the objects under investigation. The subject matter of
this paper is a logical framework of dependent type theory. 
...
itself the subject of mathematical study. 

It may actually be useful to see logical frameworks themselves
as objects subject to mathematical investigation. 

Logical frameworks for mathematics are not set in stone. 

 and neither to they
remain the same once they are declared.

When designing and maintaining a logical framework 
...
The theory of type dependency as we present it here, consists of three sorts
$C$, $F$ and $T$ for contexts, families and terms. There is a map 
