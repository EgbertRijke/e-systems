...
called context algebras. A distinctive feature of the dependent type theory of
...
with families and Jacobs' comprehension categories with context algebras. There is
a full and faithful functor from B-systems to context algebras, of which the image is
the category of stratified context algebras. To have a functor from categories with
families to context algebras, we are using an additonal coherence condition, which
