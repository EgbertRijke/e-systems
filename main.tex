...
\input{Derivations/article-models-ttderived}

%\input{article-models-ttpretty}

\part{Internal Models}\label{part:models}

\input{Internal_models/article-models-ttinternal}

%\input{article-models-ttmodels}

\part{Type constructors}

\input{Dependent_function_types/article-models-ttdp}

\input{Universes/article-models-ttuniverses}

% \part{Inductive constructions}

\input{Junk/article-models-ttind}
...
%\input{article-models-algth}

\input{Algebras/article-models-cat}

%\part{Examples of internal models}

%\input{article-models-eg}

%\input{article-models-fibsec}
