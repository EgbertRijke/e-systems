...
\begin{infarray}{c}
\inference{\jtermt{\Gamma}{A}{x}}{\jtype{\ctxext{\Gamma}{A}}{\eqtype{x}}}\\
\inference{\jtermt{\Gamma}{A}{x}}{\jtermt{\Gamma}{\subst{x}{\eqtype{x}}}{\refl{x}}}\\
\inference{\jtype{\ctxext{\Gamma}{A}}{P}\qquad\jtermt{\Gamma}{\subst{\refl{x}}{{x}{P}}}{d}}
          {\jtermt{\ctxext{{\Gamma}{A}}{\eqtype{x}}}{P}{\ind{\eqtype{x}}(d)}}\\
\inference{\jtype{\ctxext{\Gamma}{A}}{P}\qquad\jtermt{\Gamma}{\subst{\refl{x}}{{x}{P}}}{d}}
          {\jtermteq{\ctxext{{\Gamma}{A}}{\eqtype{x}}}{\subst{\refl{x}}{{x}{P}}}{\subst{\refl{x}}{{x}{\ind{\eqtype{x}}(d)}}}{d}}
\end{infarray}
We get something that looks like Paulin-Mohring equality. But we can use it to
show that every $\jtermt{\Gamma}{\ctxwk{\Gamma}{\Delta}}{f}$ is a trivial cofibration.

Suppose that $\jtype{\Delta}{Q}$. Then we have $\jtype{\Gamma}{\subst{f}{\ctxwk{\Gamma}{Q}}}$. 
For any term $\jtermt{\Gamma}{\subst{f}{\ctxwk{\Gamma}{Q}}}{d}$ we get a term 
...
\inference{\jtype{\Gamma}{A}}{\jtermt{\ctxext{\Gamma}{A}}{\subst{\proj1^A}{\eqtype{\proj1^A}}}{\refl{\proj1^A}}}
\end{infarray}
