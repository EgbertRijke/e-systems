...
{}&
  ...
  \ar[bend right=10]{dl}[swap]{\pullbackpr{1}{\ectxext\circ\efamext}{\eft}}
  \ar[dotted]{d}{\alpha_2}
  \\
\stesysf_2
  &
...
\begin{tikzcd}[column sep=large]
{}&
  \pullback{\stesysf_3}{\stesysf}{\ectxext\circ\efamext\circ\eext{2}}{\eft}
  \ar[bend left=10]{drrr}{\pullbackpr{2}{\ectxext\circ\efamext\circ\eext{2}}{\eft}}
  \ar[bend right=10]{dl}[swap]{\pullbackpr{1}{\ectxext\circ\efamext\circ\eext{2}}{\eft}}
  \ar[dotted]{d}{\alpha_3}
  \\
\stesysf_3
  &
\stesysf_4
  \ar{l}{\eft[3]}
  \ar{r}[swap]{\pullbackpr{2}{\eext{2}}{\eft[2]}}
  &
\stesysf_3
  \ar{r}[swap]{\pullbackpr{2}{\efamext}{\eft[1]}}
  &
...
\begin{align*}
\alpha_2 
  & : \stesysf_3\to\pullback{\stesysf}{\stesysf_2}{\ectxext}{\eft\circ\eft[1]\circ\eft[2]}
  \\
\alpha_3 
  & : \stesysf_4\to\pullback{\stesysf}{\stesysf_3}{\ectxext}{\eft\circ\eft[1]\circ\eft[2]\circ\eft[3]}
\end{align*}
\end{comment}
\end{proof}
