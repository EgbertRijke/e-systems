...
\end{equation*} 
\begin{itemize}
\item by letting $w(\famesys{\stesys})_0$ be the unique morphisms rendering the diagram
\begin{equation*}
\begin{tikzcd}[column sep=large]
...
\end{tikzcd}
\end{equation*}
\item by letting $w(\famesys{\stesys})_1$ be the unique morphisms rendering the diagram
\begin{equation*}
\begin{tikzcd}[column sep=large]
...
\end{tikzcd}
\end{equation*}
\item by letting $w(\famesys{\stesys})_t$ be the unique morphisms rendering the diagram
\begin{equation*}
\begin{tikzcd}[column sep=huge]
\pullback{\stesysf_2}{\stesyst_2}{\eft[1]}{\eft[1]\circ\eft[2]\circ\ebd[2]}
  \ar{rr}{\pullback{\pullbackpr{2}{\ectxext}{\eft}}{\pullbackpr{2}{\efamext}{\eft[1]\circ\ebd[1]}}{\eft}{\eft\circ\eft[1]\circ\ebd[1]}}
  \ar[dotted]{dr}{w(\famesys{\stesys})_t}
  \ar{dd}[swap]{\eft[1]^\ast(\eft[2]\circ\ebd[2])}
  & &
\pullback{\stesysf}{\stesyst_1}{\eft}{\eft\circ\eft[1]\circ\ebd[1]}
  \ar{d}{w(\stesys)_1}
  \\
  {}&
\stesyst_3
  \ar{r}{\pullbackpr{2}{\efamext}{\eft[1]\circ\ebd[1]}}
