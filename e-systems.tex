\section{Context algebras}\label{sec:esys_defn}
...
\begin{defn}
A \define{pre-context algebra} is a pre-category $\cat{F}$ with term structure
with a pre-weakening structure $W$, a pre-substitution structure $S$ and a terminal
object. A \define{unital pre-context algebra}, or simply \define{pre-context algebra}, is a non-unital pre-context algebra which also has the structure of a pre-projection system. 
\end{defn}

\begin{defn}
A \define{pre-context homomorphism} from $\mathbb{E}\to\mathbb{D}$ is a functor
...
\begin{defn}
\label{defn:esystems}
A \define{context algebra} is a unital pre-context algebra in which 
\begin{enumerate}
...
\end{enumerate}
An \define{context homomorphism} $H:\mathbb{E}\to\mathbb{D}$ is a functor from
