\section{Telescopic type systems}\label{sec:esys_defn}
...
\begin{defn}
A \define{pre-telescopic type system} is a pre-category $\cat{F}$ with term structure
with a pre-weakening structure $W$, a pre-substitution structure $S$ and a terminal
object. A \define{unital pre-telescopic type system}, or simply \define{pre-telescopic type system}, is a non-unital pre-telescopic type system which also has the structure of a pre-projection system. 
\end{defn}

\begin{defn}
A \define{pre-telescopic homomorphism} from $\mathbb{E}\to\mathbb{D}$ is a functor
...
\begin{defn}
\label{defn:esystems}
A \define{telescopic type system} is a unital pre-telescopic type system in which 
\begin{enumerate}
...
\end{enumerate}
An \define{telescopic homomorphism} $H:\mathbb{E}\to\mathbb{D}$ is a functor from
