...
declaration of valid inference rules. An inference rule is a finite list
...
\begin{itemize}
\item It is declared valid as an axiom;
\item The inference rule
\begin{equation*}
\inference{\mathcal{H}_1\quad\cdots\quad\mathcal{H}_n}{\mathcal{H}_n}
\end{equation*}
