\section{Operational syntactics for type theory before type constructors}\label{tt}
...
morphism from $P$ to $Q$ over the identity function $\idfunc[A]$ in context
...
& \inference
  { \jfam{{\Gamma}{A}}{P}
    \jfam{{\Gamma}{A}}{Q}
    \jfhom{\Gamma}{A}{A}{\idfunc[A]}{P}{Q}{f}
    }
  { \jhom{{\Gamma}{A}}{P}{Q}{f}
    }
  \\
...
$\jfhom{\Gamma}{A}{A}{\idfunc[A]}{P}{Q}{f}$, we get the judgments
\begin{align*}
& \unfold{\jhom{{\Gamma}{A}}{P}{Q}{f}}
  \\
& \unfold{\jfhom{\Gamma}{A}{A}{\idfunc[A]}{P}{Q}{f}}
\end{align*}
respectively. Therefore, we only need to verify that
$\ctxwk{P}{\subst{\idfunc[A]}{\ctxwk{A}{Q}}}\jdeq\ctxwk{P}{Q}$, which is indeed
...
& \jdeq 
  \subst
    {u}
    {{{x}{\idfunc[\ctxext{A}{P}]}}{{x}{\ctxwk{{P}{{A}{Q}}}}}}
  \tag{by \autoref{comp-ss-f}}\\
& \jdeq 
  \subst
    {u}
    {{x}{{\idfunc[\ctxext{A}{P}]}{\ctxwk{P}{{A}{Q}}}}}
  \tag{by \autoref{comp-ss-f}}\\
& \jdeq 
  \subst
    {u}
    {{x}{{\idfunc[\ctxext{A}{P}]}{\ctxwk{\ctxext{A}{P}}{Q}}}}
...
\begin{align*}
\subst{\ctxwk{P}{\idfunc[A]}}{\ctxwk{P}{{A}{P}}} 
& \jdeq 
  \ctxwk{P}{\subst{\idfunc[A]}{\ctxwk{A}{P}}}
  \\
& \jdeq 
  \ctxwk{P}{P},
\end{align*}
...
\subst{\cprojfstf{A}{P}}{\ctxwk{\ctxext{A}{P}}{Q}} 
& \jdeq 
  \subst{\ctxwk{P}{\idfunc[A]}}{\ctxwk{\ctxext{A}{P}}{Q}} 
  \tag{by definition}\\
& \jdeq 
  \subst{\ctxwk{P}{\idfunc[A]}}{\ctxwk{P}{{A}{Q}}} 
  \tag{by \autoref{comp-ww-f}}\\
& \jdeq 
  \ctxwk{P}{\subst{\idfunc[A]}{\ctxwk{A}{Q}}} 
...
\cprojfst{A}{P}{\tmext{A}{P}{x}{u}}
& \jdeq 
  \subst{\tmext{A}{P}{x}{u}}{\ctxwk{P}{\idfunc[A]}}
  \\
& \jdeq 
  \subst{u}{{x}{\ctxwk{P}{\idfunc[A]}}} 
  \\
& \jdeq 
  \subst{u}{\ctxwk{\subst{x}{P}}{\subst{x}{\idfunc[A]}}}
  \\
& \jdeq 
  \subst{x}{\idfunc[A]}
  \\
...
\cprojsnd{A}{P}{\tmext{A}{P}{x}{u}}
& \jdeq 
  \subst{\tmext{A}{P}{x}{u}}{\idfunc[P]}
  \\
& \jdeq 
  \subst{u}{{x}{\idfunc[P]}}
  \\
& \jdeq 
  \subst{u}{\idfunc[\subst{x}{P}]}
  \\
& \jdeq 
  u.
  \qedhere
...
& \jdeq 
  \subst
    ...
    {{x}{\idfunc[\ctxext{A}{{P}{Q}}]}}
  \\
& \jdeq 
  \subst{v}{{u}{{x}{\idfunc[\ctxext{A}{{P}{Q}}]}}}
  \\
& \jdeq 
  \subst{v}{{u}{{x}{\idfunc[\ctxext{{A}{P}}{Q}]}}}
  \\
& \jdeq 
  \subst{v}{{\tmext{A}{P}{x}{u}}{\idfunc[\ctxext{{A}{P}}{Q}]}}
  \\
& \jdeq 
...
& \jdeq 
  \ctxwk{A}{\subst{t}{{g}{\idfunc[\ctxext{Q}{R}]}}}
  \\
& \jdeq 
  \subst{\ctxwk{A}{t}}{\ctxwk{A}{\subst{g}{\idfunc[\ctxext{Q}{R}]}}}
  \\
& \jdeq 
  \subst{\ctxwk{A}{t}}{{\ctxwk{A}{g}}{\ctxwk{A}{\idfunc[\ctxext{Q}{R}]}}}
  \\
& \jdeq 
  \subst{\ctxwk{A}{t}}{{\ctxwk{A}{g}}{\idfunc[\ctxwk{A}{\ctxext{Q}{R}}]}}
  \\
& \jdeq 
  \subst{\ctxwk{A}{t}}{{\ctxwk{A}{g}}{\idfunc[\ctxext{\ctxwk{A}{Q}}{\ctxwk{A}{R}}]}}
  \\
& \jdeq 
  \tmext{\ctxwk{A}{Q}}{\ctxwk{A}{R}}{\ctxwk{A}{g}}{\ctxwk{A}{t}}
  \qedhere
...
\subst{x}{\tmext{Q}{R}{g}{t}}
& \jdeq 
  \subst{x}{{t}{{g}{\idfunc[\ctxext{Q}{R}]}}}
  \\
& \jdeq 
  \subst{{x}{t}}{{x}{{g}{\idfunc[\ctxext{Q}{R}]}}}
  \\
& \jdeq 
  \subst{{x}{t}}{{{x}{g}}{{x}{\idfunc[\ctxext{Q}{R}]}}}
  \\
& \jdeq 
  \subst{{x}{t}}{{{x}{g}}{\idfunc[\subst{x}{\ctxext{Q}{R}}]}}
  \\
& \jdeq 
  \subst{{x}{t}}{{{x}{g}}{\idfunc[\ctxext{\subst{x}{Q}}{\subst{x}{R}}]}}
  \\
& \jdeq 
  \tmext{\subst{x}{Q}}{\subst{x}{R}}{\subst{x}{g}}{\subst{x}{t}}.
  \qedhere
...
\subsection{Judgmental trivial cofibrations}
\begin{defn}
...
examples of judgmental trivial cofibrations. Since identity functions behave
so nicely, they are judgmental trivial cofibrations too.

\begin{lem}
The identity function
$\jhom{\Gamma}{A}{A}{\idfunc[A]}$ is a judgmental trivial cofibration
