...
The weakening morphism $\tfwk{A}^0$ gives a morphism
\begin{equation*}
\jhom
  {{{{\Gamma}{A}}{\mfam{A}}}{\mtm{A}}}
  {\ctxwk{\mtm{A}}{{\mfam{A}}{\mfam{A}}}}
...
\subsubsection{Extension acts as the identity functor on families}
\begin{equation*}
df
\end{equation*}

\subsubsection{Extension acts as the identity functor on terms}
