...
\end{align}
The following rule expresses that when the empty context or context family is
...
\end{align}
The special case where $\Gamma$ is taken to be the empty context is again
noteworthy. Also, note that we do not have to axiomatize the action of weakening
...
\subsubsection{Substitution by the term of the empty context}
\label{comp-0s}
