...
and the identity terms. The resulting theory can be seen as the structure of
dependent type theory. We note up front that what we call families over contexts
here, could have been named dependent contexts or telescopes, see
\cite{deBruijn1991,hofmann1995extensional}.
...
\autoref{pullback}. Because 
$\finc{x}{P}$ is a morphism into an extension, we will first study morphisms
into extensions more generally.
