...
trees of contexts are judgmentally equal if their leaves are, taking only the
order of the leaves into account \emph{and not the actual shape of the three}.
