...
We define
\begin{align*}
\jfamdefn*{{\Gamma}{A}}{\jhomcomp{f}{Q}}{\subst{f}{\ctxwk{A}{Q}}}\\
\jtermdefn*{{\Gamma}{A}}{\jhomcomp{f}{Q}}{\jhomcomp{f}{g}}{\subst{f}{\ctxwk{A}{g}}}.
\end{align*}
Likewise, when we have a family $\jfam{{{\Gamma}{B}}{Q}}{R}$ and a term
$\jterm{{{\Gamma}{B}}{Q}}{R}{h}$, we define
\begin{align*}
\jfamdefn*{{{\Gamma}{A}}{\jhomcomp{f}{Q}}}{\jhomcomp{f}{R}}{\subst{f}{\ctxwk{A}{R}}}\\
\jtermdefn*{{{\Gamma}{A}}{\jhomcomp{f}{Q}}}{\jhomcomp{f}{R}}{\jhomcomp{f}{h}}{\subst{f}{\ctxwk{A}{h}}}.
\end{align*}
\end{defn}
...
& \inference
  ...
  {\jfameq{{\Gamma}{A}}{\subst{\jhomcomp{f}{g}}{R}}{\subst{f}{{\ctxwk{A}{g}}{\ctxwk{{A}{B}}{R}}}}}\\
& \inference
  {\jhom{\Gamma}{A}{B}{f}
   \jhom{\Gamma}{B}{C}{g}
   \jterm{{{\Gamma}{A}}{\ctxwk{A}{C}}}{R}{h}}
  {\jfameq{{\Gamma}{A}}{\subst{\jhomcomp{f}{g}}{h}}{\subst{f}{{\ctxwk{A}{g}}{\ctxwk{{A}{B}}{h}}}}}
\end{align*}
In particular, when $\jhom{\Gamma}{C}{D}{h}$, we have
\begin{equation*}
\jhomeq{\Gamma}{A}{D}{\jhomcomp{\jhomcomp{f}{g}}{h}}{\jhomcomp{f}{\jhomcomp{g}{h}}}.
\end{equation*}
\end{lem}
...
equalities
\begin{align*}
\subst{\jhomcomp{f}{g}}{R} & \jdeq \subst{{f}{\ctxwk{A}{g}}}{R}\\
...
& \inference
  {\jhom{\Gamma}{A}{B}{f}
   \jhom{\Gamma}{B}{C}{g}
   \jfam{{\Gamma}{A}}{P}}
  {\jhomeq{\Gamma}{{A}{P}}{C}{\ctxwk{P}{\jhomcomp{f}{g}}}{\jhomcomp{\ctxwk{P}{f}}{g}}}\\
& \inference
  {\jterm{\Gamma}{B}{y}
   \jhom{\Gamma}{B}{C}{g}}
  {\jhomeq{\Gamma}{A}{C}{\jhomcomp{\ctxwk{A}{y}}{g}}{\ctxwk{A}{\subst{y}{g}}}}\\
& \inference
  {\jhom{\Gamma}{A}{B}{f}
   \jterm{\Gamma}{C}{z}}
  {\jhomeq{\Gamma}{A}{C}{\jhomcomp{f}{\ctxwk{B}{z}}}{\ctxwk{A}{z}}}
\end{align*}
\end{lem}
...
& \inference
  {\jhom{{\Gamma}{A}}{P}{Q}{f}
   \jhom{{\Gamma}{A}}{Q}{R}{g}
   \jterm{\Gamma}{A}{x}}
  {\jhomeq{\Gamma}{\subst{x}{P}}{\subst{x}{R}}{\subst{x}{\jhomcomp{f}{g}}}{\jhomcomp{\subst{x}{f}}{\subst{x}{g}}}}\\
& \inference
  {\jhom{\Gamma}{A}{B}{f}
   \jhom{\Gamma}{B}{C}{g}
   \jterm{\Gamma}{A}{x}}
  {\jtermeq{\Gamma}{C}{\subst{x}{\jhomcomp{f}{g}}}{\subst{{x}{f}}{g}}}
\end{align*}
\end{lem}
...
\inference
  {\jfam{\Gamma}{A}
   \jfam{{\Gamma}{A}}{P}}
  {\jtermeq{{\Gamma}{{A}{P}}}{\ctxwk{\ctxext{A}{P}}{\ctxext{A}{P}}}{\idfunc[\ctxext{A}{P}]}{\ctxext{\cprojfstf{A}{P}}{\cprojsndf{A}{P}}}}
\end{equation}
\end{lem}
