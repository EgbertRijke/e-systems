...
\subsection{Composition and identity terms}
...
graphical indication of the situation in which we're working.
...
\item The set of double-headed arrows must form a forest where the root of
each tree is a family of contexts over $\Gamma$. 
\item A sequence of double-headed 
arrows
\begin{equation*}
\begin{tikzcd}
P_{n+1} \ar[fib]{r} & \cdots \ar[fib]{r} & P_1 \ar[fib]{r} & A
\end{tikzcd}
\end{equation*}
...
\item A ladder of double-headed arrows
\begin{equation*}
\begin{tikzcd}
P_{n+1} \ar{r}{F_{n+1}} \ar[fib]{d} & Q_{n+1} \ar[fib]{d}\\
