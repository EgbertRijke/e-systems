...
\subsection{The basic ingredients of the theory of models}
...
& \inference
  {\jterm{\Gamma}{A}{x}}
  {\jterm{{\Gamma}{A}}{\mfam{A}}{\mfam{x}}}
  \tag{term action of $\mfam{}$}\\
& \inference
  {\jctx{\Gamma}}
...
\inference
  ...
  {\jfameq{{{\Gamma}{A}}{P}}
    {\mfam{{A}{P}}}
    {{\ctxwk{P}{\mfam{A}}}{\ctxwk{{P}{\mfam{A}}}{\mfam{P}}}}}
\end{equation*}
...
\inference
  ...
  {\jfameq
    {{{{\Gamma}{A}}{P}}{\mfam{{A}{P}}}}
    {\mtm{{A}{P}}}
    {{\ctxwk{{P}{\mfam{A}}}{{P}{\mtm{A}}}}{\ctxwk{{P}{\mfam{A}}}{\mtm{P}}}}}
\end{equation*}
