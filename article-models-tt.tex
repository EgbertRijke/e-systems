...
\end{tikzcd}
\end{equation*}
is a judgmental pullback if the following inference rules are valid:
\begin{align*}
& \inference
  { \jfam{{\Gamma}{A}}{P'}
    \jfhom{\Gamma}{A}{B}{f}{P'}{Q}{F'}
...
\end{tikzcd}
\end{equation*}
is a judgmental pullback diagram.
\end{lem}
...
\end{tikzcd}
\end{equation*}
is a pullback precisely when the square
\begin{equation*}
...
\end{tikzcd}
\end{equation*}
where the square on the right and the outer rectangle are judgmental pullback 
diagrams. Then the square on the left is a judgmental pullback diagram.
\end{lem}
